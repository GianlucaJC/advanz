                  ...
                  <div class="col-md-12">
                     <div class="form-check">
                        ...
                        <label class="form-check-label" for="read_terms">
                              I have read and agree to the Terms & Conditions (you must select country and read terms & conditions to select this box) *
                        </label>
                     </div>
                  </div>
               </div>   
            ...
            <div class="appointment_box">
               <div class="row mb-2">
                  <div class="col-md-12">
                     ...
                     To display the selection pannel, select your country in the user information section.</br>
                     Please select the testing materials you wish to receive.
                  ...
                  <div class='container-fluid'>
                     <div class="alert alert-dark mt-4" role="alert">
                        Request for a limited quantity of Ceftobiprole and Enmetazobactam powder for calibration or research purpose may be sent to <a href='mailto:clinicaldevelopment@advanzpharma.com'>clinicaldevelopment@advanzpharma.com</a>
                     </div>
                  </div>   
