               ...
               <div class="appointment_box">
                  <div class="jumbotron">
                     <p style='text-align:justify'>
                       <h3>
                        Welcome to the ADVANZ PHARMA <b>A</b>ntimicrobial <b>S</b>usceptibility <b>T</b>esting <b>I</b>nvestigational <b>P</b>rogramme
                       </h3>
                     </p>
      ...
      <div class="appointment_section mt-2">
         <div class="container">
            <div class="appointment_box">
               <h2>Goal of ASTIP</h2>
                  <p style='text-align:justify'>            
                     ADVANZ PHARMA offers you the opportunity to join the Antimicrobial Susceptibility Testing Investigational Programme (ASTIP). The ASTIP provides In Vitro Diagnostics (IVD) materials for susceptibility testing at no cost. The goal is to help healthcare institutions to better understand the susceptibility of pathogens, the appropriate use of antibiotics and the prevention of antimicrobial resistances in your healthcare institution. By registering to ASTIP you can order a limited quantity of in vitro testing material for research use only and upload anonymised results. Healthcare Organisation are allowed to order one type of testing material  per year per product Disks and Strips are manufactured by Liofilchem® s.r.l. (<a href='https://www.liofilchem.com' class='link-info'>https://www.liofilchem.com</a>) and automated testing plates by Thermo Fisher Scientific (<a href='https://www.thermofisher.com' class='link-info'>https://www.thermofisher.com</a>)
                  </p>
               </div>
         </div>
      </div>
